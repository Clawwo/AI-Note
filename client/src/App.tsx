...
export default function App() {
    ...
    setNotebooks(
      data.data.data.map((notebook) => ({
        ...
        updatedAt: notebook.updated_at
          ? new Date(notebook.updated_at)
          : new Date(notebook.created_at),
      })),
    );
  };
  ...
  return (
    <div className="flex h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      {/* Sidebar */}
      <div className="flex flex-col bg-white border-r border-gray-200 shadow-sm w-80">
        <div className="p-4 border-b border-gray-200 bg-gradient-to-r from-white to-gray-50">
          <div className="flex items-center justify-between mb-4">
            <h1 className="text-xl font-bold text-transparent text-gray-900 bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text">
              AI Notetaking
            </h1>
          ...
          {(selectedNotebook || selectedNote) && (
            <Button
              ...
              className="justify-center w-full text-gray-600 hover:bg-gray-100"
            >
